...
public class MyBatisPlusCodeUtil {
    private static final String ENTITY_IGNORE_PREFIX="rb_";
    ...
    public static void main(String[] args) {
        try {
            generator("gp",//作者
                    "jdbc:mysql://127.0.0.1:3306/woniu-shopping?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai",
                    "com.mysql.cj.jdbc.Driver",//数据库驱动
                    "root",//数据库帐号
                    "123456",//数据库密码
                    "com.goodservice",//项目最大的包名
                    "good-service",//项目名或项目模块名
                    "tb_spu");//要操作的表名,多个表名用逗号隔开
